  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm opacity-50 w-[80%]">
          Enter your shipping information below so next time you order, you
          don&apos;t have to bother filling it out again
        </p>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-12 gap-[15px] lg:gap[30px]">
          ...
          <div className="col-span-12 md:col-span-12 lg:col-span-12">
            <Alert>
              ...
              <AlertTitle>
                Want to update name, email or phone number?
              </AlertTitle>
              <AlertDescription>
                You can update this information on the account page.{" "}
